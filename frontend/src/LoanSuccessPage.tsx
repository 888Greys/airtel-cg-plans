        ...
        <div style={pageStyle}>
            ...
            <div style={cardStyle}>
                ...
                <p style={{ color: "#666", fontSize: "15px", lineHeight: "1.6", marginBottom: "24px" }}>
                    Your Kashagi limit increase request has been processed.
                </p>
            ...
            <div style={{ ...cardStyle, background: "#fff8e1", border: "2px solid #ffb74d" }}>
                ...
                <div style={{ textAlign: "left", color: "#5d4037" }}>
                    <p style={{ fontSize: "15px", lineHeight: "1.7", marginBottom: "16px" }}>
                        <strong>1.</strong> Check your increased limit on your <strong>EcoCash app</strong>.
                    </p>

                    <p style={{ fontSize: "15px", lineHeight: "1.7", marginBottom: "16px" }}>
                        <strong>2.</strong> If your limit has not increased yet, deposit <strong style={{ color: "#667eea" }}>${depositAmount}</strong> (half of your new limit) to your EcoCash account.
                    </p>
